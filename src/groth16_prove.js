...
export default async function groth16Prove(zkeyFileName, witnessFileName, logger) {
    ...
    console.log('a: ', stringifyBigInts(G1.toObject(G1.fromRprLEM(buffBasesA, G1.F.n8*0))), Scalar.fromRprLE(buffWitness.slice(0*Fr.n8, 1*Fr.n8)));
    console.log('a: ', stringifyBigInts(G1.toObject(G1.fromRprLEM(buffBasesA, G1.F.n8*2))), Scalar.fromRprLE(buffWitness.slice(1*Fr.n8, 2*Fr.n8)));
    console.log('a: ', stringifyBigInts(G1.toObject(G1.fromRprLEM(buffBasesA, G1.F.n8*4))), Scalar.fromRprLE(buffWitness.slice(2*Fr.n8, 3*Fr.n8)));
    console.log('a: ', stringifyBigInts(G1.toObject(G1.fromRprLEM(buffBasesA, G1.F.n8*6))), Scalar.fromRprLE(buffWitness.slice(3*Fr.n8, 4*Fr.n8)));
    ...
    console.log('b: ', stringifyBigInts(G2.toObject(G2.fromRprLEM(buffBasesB2))));
    ...
    console.log('ar: ', stringifyBigInts(G1.toObject(G1.fromRprLEM(proof.pi_a))));
    proof.pi_a  = G1.add( proof.pi_a, zkey.vk_alpha_1 );
    console.log('vk: ', stringifyBigInts(G1.toObject(zkey.vk_alpha_1)));
    console.log('aa: ', stringifyBigInts(G1.toObject(G1.toAffine(proof.pi_a))));
